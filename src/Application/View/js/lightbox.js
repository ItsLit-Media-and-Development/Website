...
(function($) {
  ...
  $.fn.lightbox = function(light) {
	  ...
	  $(this).click(function(e) {
	    ...
	    //     $('.lightbox ul').append(
	    //       '<li>' +
	    //         '<iframe src="' + $(this).attr('href') + '" allowfullscreen="true"></iframe>' +
	    //       '</li>'
	    //     );
	    //   });
	    // }
	    ...
	    // }
		//
		// 	if (matches = source.match(/\/\/.*?twitch\.[a-z]+\/\?clip=([^&\s]+)/)) {
		// 		video = 'https://clips.twitch.tv/embed?clip=' + matches[1];
		// 	}
		//
	    // if ( video ) {
	    //   $('.lightbox ul').append(
	    ...
	    // }
	      ...
	      $('.lightbox ul').append(
	        // '<li>' +
	        //   '<iframe src="' + $(this).attr('href') + '" allowfullscreen="true" width="640px" height="360px"></iframe>' +
	        // '</li>'
			'<li class="lightbox-video 1">' +
	          '<div class="embed-responsive embed-responsive-16by9">' +
	          '<iframe class="embed-responsive-item" src="' + $(this).attr('href') + '" height="640" width="360" frameborder="0" scrolling="no" allowfullscreen="true"></iframe>' +
	          '</div>' +
	        '</li>'
	      );
